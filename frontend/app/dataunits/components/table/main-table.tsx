...
import { RotateCw, SheetIcon, Trash2 } from "lucide-react";
                    ...
                    <div className="grid grid-cols-3 gap-4 p-4 shadow-md sm:rounded-lg">
                        ...
                        <div>
                            <div className="flex w-full shrink-0 flex-col items-stretch justify-end space-y-2 md:w-auto md:flex-row md:items-center md:space-x-3 md:space-y-0">
                                ...
                                <ExportTableButton handleExport={handleExport} loadingDownloadFile={loadingDownloadFile} nameTable="Lokasi Kerja" />
                            </div>
                        </div>
                    </div>
                                        ...
                                        cell: ({ row }: { row: { original: GetDataUnitsDataUnit } }) => {
                                            ...
                                            return (
                                                <div className="flex items-center space-x-2">
                                                    <DetailDataButtonFromTable onClick={() => handleForm(dataUnit.id)} />
                                                    <DeleteDataButtonFromTable onClick={() => handleClickToDelete(dataUnit.id)} />
                                                </div>
                                            );
                                        },
                                    };
